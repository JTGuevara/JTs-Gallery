/* FILE: Gallery.java
 * DESCRIPTION: The Gallery class is the collection class of the image gallery application. A Gallery object represents an image gallery and is structured 
 *      as an array deque with Image objects as the data type of the elements in the deque
 * 
 * FUNCTIONS:
 *    public Gallery();	
